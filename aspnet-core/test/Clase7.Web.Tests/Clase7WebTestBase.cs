...
{
    public abstract class Clase7WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Clase7WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Clase7WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Clase7DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Clase7DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Clase7DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Clase7DbContext, Task<T>> func)
        {
            T result;
